    ...
    <div
      className={cn(
        buttonVariants({
          ...
          variant: "secondary",
          className:
            "gap-0 divide-x px-0 font-sans active:scale-none dark:divide-white/10 divide-dashed border border-black/10 dark:border-white/10 rounded-xl corner-squircle hover:bg-black/5 dark:hover:bg-white/5 border-dashed",
        }),
      )}
    >

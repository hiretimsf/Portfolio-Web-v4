...
const browserCollections = {
  ...
  featuredApps: create.doc("featuredApps", {"full-stack-blog-app.mdx": () => import("../features/home/content/featured-apps/full-stack-blog-app.mdx?collection=featuredApps"), "just-fucking-run.mdx": () => import("../features/home/content/featured-apps/just-fucking-run.mdx?collection=featuredApps"), "lazy-panda.mdx": () => import("../features/home/content/featured-apps/lazy-panda.mdx?collection=featuredApps"), }),
  privacy: create.doc("privacy", {"privacy.mdx": () => import("../features/privacy/content/privacy.mdx?collection=privacy"), }),
  projects: create.doc("projects", {"full-stack-blog-app.mdx": () => import("../features/projects/content/full-stack-blog-app.mdx?collection=projects"), "just-fucking-run.mdx": () => import("../features/projects/content/just-fucking-run.mdx?collection=projects"), "lazy-panda.mdx": () => import("../features/projects/content/lazy-panda.mdx?collection=projects"), "local-market-place-app.mdx": () => import("../features/projects/content/local-market-place-app.mdx?collection=projects"), "portfolio-app-java.mdx": () => import("../features/projects/content/portfolio-app-java.mdx?collection=projects"), "portfolio-app-kotlin.mdx": () => import("../features/projects/content/portfolio-app-kotlin.mdx?collection=projects"), "portfolio-website-v0.mdx": () => import("../features/projects/content/portfolio-website-v0.mdx?collection=projects"), "portfolio-website-v1.mdx": () => import("../features/projects/content/portfolio-website-v1.mdx?collection=projects"), "portfolio-website-v2.mdx": () => import("../features/projects/content/portfolio-website-v2.mdx?collection=projects"), "portfolio-website-v3.mdx": () => import("../features/projects/content/portfolio-website-v3.mdx?collection=projects"), "product-landing-page.mdx": () => import("../features/projects/content/product-landing-page.mdx?collection=projects"), "project-marketing-materials.mdx": () => import("../features/projects/content/project-marketing-materials.mdx?collection=projects"), "renewable-energy-project.mdx": () => import("../features/projects/content/renewable-energy-project.mdx?collection=projects"), "tshirt-design-app.mdx": () => import("../features/projects/content/tshirt-design-app.mdx?collection=projects"), }),
